...
public class Myclass extends AppCompatActivity implements MaterialTabListener {
    ...
    public String getLesson(final String mToken) {
        ...
        if (networkInfo == null || !networkInfo.isAvailable()) {
            ...
            Map<String, String> termMarks = Info.getClassInfo(Myclass.this);
            ClassInfo = termMarks.get("ClassInfo");
            if (ClassInfo != null) {
                try {
                    JSONObject jsonObject = new JSONObject(ClassInfo);
            ...
            dialog = ProgressDialog.show(Myclass.this, "", "加载中...");
            new Thread() {
                public void run() {
                    String result = Netget.getClassInfo(mToken);
                    ClassInfo = result;
                    Info.saveClassInfo(Myclass.this, ClassInfo);
